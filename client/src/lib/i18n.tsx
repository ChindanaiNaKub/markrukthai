...
const EN: Record<string, string> = {
  ...
  'home.play_bot_desc': '10 strength levels',
  'home.play_bot_long_desc': 'Choose from 10 bot strength levels and practice from beginner drills up to longer calculation battles.',
  ...
  'bot.setup_desc': 'Choose a strength, pick your side, then start a practice game. Random side is decided only when the game begins.',
...
const TH: Record<string, string> = {
  ...
  'home.play_bot_desc': '10 ระดับความแข็งแกร่ง',
  'home.play_bot_long_desc': 'เลือกความแข็งแกร่งของบอทได้ 10 ระดับ ตั้งแต่ฝึกพื้นฐานไปจนถึงเกมที่ต้องคำนวณลึกขึ้น',
  'home.puzzles': 'ปริศนา',
  ...
  'bot.setup_desc': 'เลือกความแข็งแกร่ง เลือกฝั่ง แล้วเริ่มเกมซ้อมได้เลย หากเลือกสุ่ม ระบบจะตัดสินฝั่งให้ตอนเริ่มเกมเท่านั้น',
